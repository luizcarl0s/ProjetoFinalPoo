...
public class ServicoComunitario {
    ...
    public ServicoComunitario(int id, String nome, String descricao, Usuario responsavel, int vagas, String horario) {
        this.id = id;
        this.nome = nome;
    ...
    public String resumo() {
        return "ID: " + id + " | Nome: " + nome + " | Responsável: " + responsavel.getNome() + " | Vagas restantes: " + (vagas - inscritos.size()) + " | Horário: " + horario;
    }
